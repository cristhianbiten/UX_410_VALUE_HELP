sap.ui.define(
  ...
  function (Controller, Filter, FilterOperator, Fragment) {
    ...
    return Controller.extend(
      "student10.sap.training.valuehelp.controller.Main",
      {
        onInit: function () {
        ...
        onValueHelpRequest: function (oEvent) {
          ...
          if (!this._oValueHelpDialog) {
            Fragment.load({
              name: "student10.sap.training.valuehelp.view.CarrierSelectionDialog",
              controller: this,
            }).then(
              function (oFragment) {
        ...
        _createFlightsTable: function (sPath) {
          ...
          Fragment.load({
            ...
            name: "student10.sap.training.valuehelp.view.Flights",
            controller: this,
          }).then(
            function (oFragment) {
