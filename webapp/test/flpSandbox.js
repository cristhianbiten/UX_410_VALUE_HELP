		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Value Help App",
									"targetURL": "#student10saptrainingvaluehelp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student10saptrainingvaluehelp-display": {
								"semanticObject": "student10saptrainingvaluehelp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student10.sap.training.valuehelp",
									"url": sap.ui.require.toUrl("student10/sap/training/valuehelp")
								}
							}
						}
					}
